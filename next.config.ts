...
const publicCsp = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' https://plausible.io https://cdn.weglot.com",
  ...
  "connect-src 'self' https://*.sanity.io wss://*.sanity.io https://plausible.io https://*.weglot.com",

    ...
    <div id={sectionAnchor(data._key, data.overskrift)} className={styles.textSection}>
      {hasSideCol && (
        <div className={styles.textCtaCol}>
          {/* The heading rides down its own column while the body text scrolls
              past, so a long section keeps saying what it is about. */}
          <div className={styles.textCtaSticky}>
